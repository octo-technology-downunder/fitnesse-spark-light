...
public class FileUtil {
    ...
    public static File prepareOutputFile(String fileName) throws IOException {
        ...
        File lockFile = new File(Constants.OUTPUT + fileName + ".lock");
        if (lockFile.exists())
            throw new RuntimeException(
                    "File " + file.toString() + " already exists. You should check if there isn't already another program running using this file. If not, delete this file and retry.");
    ...
    public static void unlockOutputFile(String fileName) {
        new File(Constants.OUTPUT + fileName + ".lock").delete();
    }
